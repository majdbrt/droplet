...
function ChatPane() {
    ...
    return (
        ...
        <aside className={` sticky overflow-y-hidden h-screen flex flex-col w-full  md:w-[40%] ${darkTheme ? 'bg-neutral-900' : 'bg-white '}  ${selectedChat ? 'hidden md:block' : ''} `}>
            <div className="md:max-h-[20%]">
