...
function LoginForm() {
    ...
    return (
        <div className="flex-1 flex flex-col items-center overflow-x-hidden h-full w-full " >
            ...
            <div className={`mb-10 ${darkTheme ? 'bg-neutral-900 hover:border-white' : 'bg-white  hover:border-black'} font-medium text-xl text-neutral-400 scale-90   hover:scale-95 border-2 border-neutral-500  rounded-full`}>
