    ...
    return (
        <div className="flex-1 flex flex-col items-center  h-full w-full " >
            ...
            <form className=" mx-auto py-12  px-2 md:p-20 md:pt-14 md:pb-12 rounded-lg h-auto" onSubmit={handleSubmit}>
                <div className="relative md:m-10  mb-0 md:mb-0 mt-5" >
            ...
            <div className={`${darkTheme ? 'bg-neutral-900 hover:border-white' : 'bg-white  hover:border-black'} font-medium text-xl text-neutral-400 scale-90   hover:scale-95 border-2 border-neutral-500  rounded-full`}>
