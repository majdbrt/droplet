    ...
    return (
        <div className="flex flex-col my-auto items-center overflow-x-hidden  w-full " >
            ...
            <form className=" w-[80%] md:w-fit md:mx-auto py-14 px-2 md:p-20 md:pt-10 md:pb-7 pb-8 h-auto" onSubmit={handleSubmit} >
                ...
                <p className={`${valid.lastName && valid.firstName ? 'invisible' : ''} flex flex-row md:w-96 w-[95%] justify-between mx-auto   text-rose-500 pt-2 text-left`}>Please enter a valid name</p>
                ...
                <div className=" w-80 text-center md:w-96 mx-auto text-[9px] md:text-[11px] ">
